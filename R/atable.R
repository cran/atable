...
#' \describe{
#' \item{\code{'Raw'}: }{A list with two elements called \code{'statistics_result'} and \code{'tests_result'}, that
...
#' \describe{
#'  \item{\code{'statistics_result'}: }{ contains a data.frame with colnames \code{split_cols, group_col, target_cols}.
